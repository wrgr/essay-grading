...
from ..core.llm import llm_chat, _extract_json
...
def _generate_instructor_summary(model, api_key, base_url, summary_system, summary_prompt,
    ...
    """
    # Platform addition: skip the call outright in keyword-fallback mode (no
    # configured provider) instead of burning the retry ladder on a dead endpoint.
